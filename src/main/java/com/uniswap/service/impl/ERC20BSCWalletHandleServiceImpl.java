...
import com.uniswap.service.ERC20BSCWalletHandleService;
import com.uniswap.service.ERC20WalletHandleService;
...
//    }
    ...
    /**
     * 创建PairCreated的event对象
     *
     * @return
     */
    @Override
    public String createPairCreatedEvent() {
     ...
     */
    @Override
    public String createDepositsEvent() {
        Event event = new Event("Deposits",
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {},
                        new TypeReference<Address>() {},
                        new TypeReference<Uint256>() {}
                        ));
